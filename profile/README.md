...
Gatherspiel is a non commercial open source platform to promote third places. As a starting point, the project has a site specific for board games in the Washington, DC area, https://dmvboardgames.com/. 

The platform is actively looking for contributors. See the following documentation to setup a development environment and get started [here](https://github.com/gatherspiel/development/blob/main/CONTRIBUTING.md)
